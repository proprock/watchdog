...
- [ ] **WD-002 - Provider compatibility spike.** Check current hook schemas and record synthetic fixtures, then sanitized live CLI/desktop traces on available operating systems. Check detached children after harness exit, subagent IDs, and tool coverage. Acceptance: a supported/unsupported/not-tested matrix without promises of unavailable events.
