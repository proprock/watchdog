...
- [ ] **WD-008 - CLI observation and M1 validation.** Project commands, doctor, sessions list/show; latency/idle overhead baseline. Depends on WD-005/006/007. Acceptance: two providers in worktrees, three operating systems, data surviving restart, explicit gaps, and a verified matrix; measured p95 hook latency target of 250 ms or less.
